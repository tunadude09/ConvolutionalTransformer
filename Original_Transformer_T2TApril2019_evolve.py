...
class TransformerOriginalApril2019Evolve(t2t_model.T2TModel):
  """Attention net.  See file docstring."""

  def __init__(self, *args, **kwargs):
    super(TransformerOriginalApril2019Evolve, self).__init__(*args, **kwargs)
  ...
  def _greedy_infer(self, features, decode_length, use_tpu=False):
    ...
    if (self._target_modality_is_real or
      ...
      return super(TransformerOriginalApril2019Evolve, self)._greedy_infer(features, decode_length)
