...
**************************************************************************************************************************
**************************************************************************************************************************
TODO: Put Conv Transformer Layer here!
**************************************************************************************************************************
**************************************************************************************************************************
"""
...
class TransformerOriginalApril2019(t2t_model.T2TModel):
  """Attention net.  See file docstring."""

  def __init__(self, *args, **kwargs):
    super(TransformerOriginalApril2019, self).__init__(*args, **kwargs)
  ...
  def _greedy_infer(self, features, decode_length, use_tpu=False):
    ...
    if (self._target_modality_is_real or
      ...
      return super(TransformerOriginalApril2019, self)._greedy_infer(features, decode_length)
